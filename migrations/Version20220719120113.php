...
final class Version20220719120113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE process (id INT AUTO_INCREMENT NOT NULL, cpu_need INT NOT NULL, ram_need INT NOT NULL,  PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
